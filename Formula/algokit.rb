class Algokit < Formula
  ...
  url "https://github.com/algorandfoundation/algokit-cli/archive/refs/tags/v0.1.1.tar.gz"
  sha256 "e5ead10f3565afe42a38b3428ca6ff8a6fb37d44f21a3d7281a026adc2be53ed"
  license "MIT"
  ...
  resource "copier" do
    url "https://files.pythonhosted.org/packages/a7/fb/53c73cc0034360233f667cf394f2c1e6789b0f600ea2e0b5f7b4f306972f/copier-7.1.0a0.tar.gz"
    sha256 "036e776b37563cd4fe7e76080f05808eb7b14d3debfe50fdc292844cc028eafb"
  end
  ...
  test do
    assert_equal "algokit, version 0.1.1", shell_output(bin/"algokit --version").strip
  end
end
